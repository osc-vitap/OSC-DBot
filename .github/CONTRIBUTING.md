...
Please note we have a [Code Of Conduct](https://github.com/SVijayB/OSC-DBot/blob/master/.github/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
### Pull Request Process
 ...
 - Ensure that the pull request is being sent from a hotfix/feature branch and not from `master/main`.
...
In short, when you submit code changes, your submissions are understood to be under the same [Apache-2.0 License](https://github.com/SVijayB/OSC-DBot/blob/master/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.